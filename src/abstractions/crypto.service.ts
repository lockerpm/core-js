...
export abstract class CryptoService {
  ...
  abstract addOrgKeys: (orgs: ProfileOrganizationResponse[]) => Promise<void>
  ...
  abstract makeAccessKey: (orgKey: string) => Promise<[EncString, SymmetricCryptoKey]>
  ...
  abstract generateMemberKey: (publicKey: string, org: any) => Promise<string>
}
