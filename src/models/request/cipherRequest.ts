...
export class CipherRequest {
  ...
  constructor(cipher: Cipher) {
    ...
    this.environmentId = cipher.environmentId
    ...
    case CipherType.Secret:
      this.secret = new SecretApi()
      this.secret.description = cipher.secret.description != null ? cipher.secret.description.encryptedString : null
      this.secret.key = cipher.secret.key != null ? cipher.secret.key.encryptedString : null
      this.secret.value = cipher.secret.value != null ? cipher.secret.value.encryptedString : null
      break
    case CipherType.Environment:
      this.environment = new EnvironmentApi()
